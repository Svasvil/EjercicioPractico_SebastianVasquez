...
import farmacia.service.FirebaseStorageService;
import java.io.File;
...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException {
        ClassPathResource json = new ClassPathResource(FirebaseStorageService.rutaJsonFile + File.separator + FirebaseStorageService.archivoJsonFile);
        BlobId blobId = BlobId.of(FirebaseStorageService.BucketName, FirebaseStorageService.rutaSuperiorStorage + "/" + carpeta + "/" + fileName);
